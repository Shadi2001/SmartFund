      ...
      <nav className="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
          <div className="navbar-nav ms-auto py-0 ">
            ...
            <button type="button" onClick={AboutScroll} className="nav-item nav-link btn btn-link">
              About
            </button>
            <button type="button" onClick={ServicesScroll} className="nav-item nav-link btn btn-link">
              Services
            </button>
